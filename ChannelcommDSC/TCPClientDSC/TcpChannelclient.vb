...
Public Class TcpChannelClient
    ...
    Public Function AddnewTcpClient(ByVal ChannelName As String, ByVal comminfo As String, ByVal polltime As Integer,
        ...
        If Not comminfo.Contains("(") Then
            ...
            If TcpClns.checkKey(Skey) = False Then
                ...
                AddnewTcpClient = TcpClns.Add(comminfo, Me.Timeout, Enable, Skey) 'skey 做关键字
        ...
        Else
            ...
            If TcpClns.checkKey(Skey) = False Then
                ...
                AddnewTcpClient = TcpClns.Add(s1, Me.Timeout, Enable, Skey) 'skey 做关键字
            ...
            If TcpClns.checkKey(Skey) = False Then
                ...
                AddnewTcpClient = TcpClns.Add(s2, Me.Timeout, Enable, Skey) 'skey 做关键字
    ...
    Private Sub M_DataArrival(ByVal CommInfo As String, ByVal mValue As Object, ByVal bytesTotal As Integer) _
        Handles M.DataArrival
