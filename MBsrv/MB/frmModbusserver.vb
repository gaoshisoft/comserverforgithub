...
Friend Class frmModbusserver
    ...
    Private Sub Combo1_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Combo1.Enter
        ...
        j = Devices.Count
        For i = 1 To j
            Combo1.Items.Add(CStr(Devices(i).deviceAddr))
        Next i
    ...
    Private Sub Command2_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command2.Click
        Dim fwrite As New fwrite With {.MBDevices = Me.Devices}
        fwrite.Show()
    End Sub
    ...
    Private Sub Timer1_Tick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles tmr.Tick
        ...
        End If
        Dim D As Device
        D = Devices.GetDevicefromAd(CInt(Combo1.Text))
        ...
        Else
            ...
            For i = 0 To 3
                If Option2.Checked = True Then
                    ListView2.Columns.Item(i).Width = 200
                Else
                    ListView2.Columns.Item(i).Width = 150
                End If
            Next i
            ...
            If CurrentPosition + 1 <= D.MBadressQuantity Then
                ...
                Select Case Combo2.Text
                    ...
                    Case "Coil Status"
                        ...
                        MBad = Format(0 + CurrentPosition + 1, "000000")
