...
<System.Runtime.InteropServices.ProgId("Device_NET.Device")> Public Class Device
    ...
    Public Function ReadModbusbyAD(ByVal mbName As String, ByVal Datatype As Datatype, Optional ByVal Bit As Object = Nothing) As String
        ...
        End Select
        'UPGRADE_WARNING: Couldn't resolve default property of object i. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadModbusbyAD. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ReadModbusbyAD = i
    End Function
    Function ReadValueSwapByte(ByVal mbName As String, ByVal Datatype As Datatype) As String
        ...
        Select Case Left(mName, 1)
            Case "4"
                Select Case Datatype
                    ...
                    Case 2 '浮点数形式
                        'UPGRADE_WARNING: Couldn't resolve default property of object i. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                        i = GetFloatSwapByteByad(mName, False)
                    Case 3
                        'UPGRADE_WARNING: Couldn't resolve default property of object i. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                        i = GetFloatSwapByteByad(mName, True)
                    Case 4
                        i = GetDoubleValue(mName, True, True)
                    Case 5
                        i = GetDoubleValue(mName, False, True)
                End Select
        ...
        End Select
        'UPGRADE_WARNING: Couldn't resolve default property of object i. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        'UPGRADE_WARNING: Couldn't resolve default property of object ReadValueSwapByte. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ReadValueSwapByte = i
    End Function
	Public Function WriteModbusbyAD(ByVal mbName As String, ByVal Mbvalue As Object, ByVal Datatype As Datatype) As String
        ...
        Dim Tmp(3) As Byte
        Try
            If Mbvalue > 65535 And Datatype = Datatype.整型 Then
                Exit Function
            End If
            ...
            If Mbvalue < 0 And Datatype = Datatype.整型 Then
                Exit Function
            End If
    ...
    Function CRC16(ByVal Data() As Byte) As Object
        ...
        CRC16 = VB6.CopyArray(ReturnData)
    End Function
	...
	Private Sub Class_Terminate_Renamed()
		Dim mvarDTblock As Object
		Dim mvarcParameters As Object
		Dim mvarModemmbdevices As Object
		Dim mvarDevices As Object
		...
		mvarDevices = Nothing
		'UPGRADE_NOTE: Object mvarModemmbdevices may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		mvarModemmbdevices = Nothing
		'UPGRADE_NOTE: Object mvarcParameters may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		mvarcParameters = Nothing
		'UPGRADE_NOTE: Object mvarDTblock may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		mvarDTblock = Nothing
    ...
    Function GetMBTCPResponsedataFrame(ByVal mbdata() As Byte) As Object
        ...
        Select Case mbdata(7)
            ...
            Case 5
                ...
                '确定是否有正确的地址
                'Dim RLad As Long
                'UPGRADE_WARNING: Couldn't resolve default property of object RLad. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                ...
                Else
                    ...
                    CoilStatus(RLad) = 0
                End If
                Mbresponse = VB6.CopyArray(mbdata)
            ...
            Case 16
                ...
                '   Me.NextcommandShouldbeWrite = True
        End Select
        'UPGRADE_WARNING: Couldn't resolve default property of object GetMBTCPResponsedataFrame. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        GetMBTCPResponsedataFrame = VB6.CopyArray(Mbresponse)
    ...
    Function GetMBRTUResponsedataFrame(ByVal mbdata() As Byte) As Object
        ...
        On Error Resume Next
        Dim FC As String
        FC = VB6.Format(mbdata(1), "00")
        If InStr(1, "01,02,03,04,05,06,15,16", FC) = 0 Then
            exceptioncode = 1
            'UPGRADE_WARNING: Couldn't resolve default property of object RTUExceptionResponse(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ...
        Select Case mbdata(1)
            Case 3
                ...
                Next i
                'UPGRADE_WARNING: Couldn't resolve default property of object getCrcframe(). Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
            ...
            Case 5
                ...
                End If
                Mbresponse = VB6.CopyArray(mbdata)
                'UPGRADE_WARNING: Couldn't resolve default property of object GetMBRTUResponsedataFrame. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
                GetMBRTUResponsedataFrame = VB6.CopyArray(mbdata)
                '       Me.NextcommandShouldbeWrite = True
            Case 6
                '确定是否有正确的值
                '     Dim RLvl As Long
    ...
    Function ExceptionResponse(ByVal mbdata() As Byte, ByVal exceptioncode As Byte) As Object
        ...
        'UPGRADE_WARNING: Couldn't resolve default property of object ExceptionResponse. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
        ExceptionResponse = VB6.CopyArray(Mbresponse)
    End Function
