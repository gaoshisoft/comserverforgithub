...
Class CSDtNode
    ...
    Sub New(ByVal P As TreeNode, ByVal NodText As String, ByVal D As CSDataBlock)
        MyBase.New()
        ...
        CopyCtrlposition(Fconfig.PanelCSLLj, Fconfig.txtCSAD, txtSlaveDevID)
    End Sub
    ...
    Sub DisDataBlock()
        ...
        Fconfig.lblCSparaaddr.Text = " 累计流量(浮点)：" & CStr(400000 + Me.DtBlock.SvrMBADStart + 1) & " 瞬时流量：" &
                                     CStr(400000 + Me.DtBlock.SvrMBADStart + 3) &
                                     " 压力：" & CStr(400000 + Me.DtBlock.SvrMBADStart + 5) &
                                     " 温度：" & CStr(400000 + Me.DtBlock.SvrMBADStart + 7) '& _
        '" 温度：" & CStr(400000 + Me.DtBlock.SvrMBADStart + 9) & _
