...
Class MBTCPDtNode
    ...
    Public DtBlock As GPRSComServer.MBTCPDataBlock
    ...
    Sub New(ByVal P As TreeNode, ByVal NodText As String, ByVal Dt As MBTCPDataBlock)
        MyBase.New()
        ...
        CopyCtrlposition(Fconfig.ModbusTCP, Fconfig._TxtAD_0, txtSlaveDevID)
        txtStartAD = New TextBox
        txtStartAD.Text = DtBlock.startAD
        CopyCtrlposition(Fconfig.ModbusTCP, Fconfig._TxtStartAD_0, txtStartAD)

        txtLength = New TextBox
        txtLength.Text = DtBlock.Length
        CopyCtrlposition(Fconfig.ModbusTCP, Fconfig._TxtLength_0, txtLength)
    ...
    Sub DisDataBlock()
        ...
        'Fconfig()
        Fconfig.lblmbtcpaddr.Text = " 地址空间：" & Val(Left(Me.txtStartAD.Text, 1) & "00000") + Val(CStr(Me.DtBlock.SvrMBADStart + 1)) & _
