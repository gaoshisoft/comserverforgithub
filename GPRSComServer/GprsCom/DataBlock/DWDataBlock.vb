    ...
    Function GetValueFromRvData(ByVal length As Integer, ByVal Rvdata() As Byte) As Boolean _
        ...
        Select Case Me.FC
            Case 3
                ...
                Me.GKLJ = Val(Rvdata(7).ToString("X2") & Rvdata(8).ToString("X2"))*100000 +
                          Val(Rvdata(9).ToString("X2") & Rvdata(10).ToString("X2"))*10
                Me.LJLL = Val(Rvdata(11).ToString("X2") & Rvdata(12).ToString("X2"))*100000 +
                          Val(Rvdata(13).ToString("X2") & Rvdata(14).ToString("X2"))*10 +
                          Val(Rvdata(15).ToString("X2") & Rvdata(16).ToString("X2"))*0.001
                Me.GKLJ = Me.GKLJ*Me.LjllXS
                Me.LJLL = Me.LJLL*Me.LjllXS
                Me.GKSS = GetFloatValueByad(12, True, Rvdata)
                Me.SSLL = GetFloatValueByad(14, True, Rvdata)
                Me.YL = GetFloatValueByad(20, True, Rvdata)
                Me.WD = GetFloatValueByad(24, True, Rvdata)
                ...
                Mbs.WritevaluebyAd(Me.SvrDevAd, CStr(400000 + Me.SvrMBADStart + 13), MBsrv.Device.Datatype.浮点数,
                                   Me.PowerState)
        End Select
