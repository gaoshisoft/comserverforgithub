    ...
    Function GetValueFromRvData(ByVal length As Integer, ByVal Rvdata() As Byte) As Boolean _
        ...
        Select Case Me.FC
            Case 3
                ...
                Me.GKLJ = GetUint32Value(Rvdata, 3)
                Me.LJLL = GetUint32Value(Rvdata, 11)
                'Me.GKLJ = Me.GKLJ * Me.LjllXS
                'Me.LJLL = Me.LJLL * Me.LjllXS
                Me.GKSS = GetFloatValueByad(35, True, Rvdata)
                Me.SSLL = GetFloatValueByad(39, True, Rvdata)
                Me.WD = GetFloatValueByad(43, True, Rvdata)
                Me.YL = GetFloatValueByad(47, True, Rvdata)
